                        ...
                        <div class="row">
                            ...
                            <form:form method="post" action="/admin/product/create" modelAttribute="newProduct" class="row" enctype="multipart/form-data">
                                ...
                                <div class="mb-3 col-12 col-md-6">
                                    ...
                                    <input class="form-control" type="file" id="productImageFile" accept=".png, .jpg, .jpeg" name="productImageFile"/>
                                </div>
                                 <div class="col-12 mb-3">
                                    <img style="max-height: 250px; display: none;" alt="product preview" id="productImagePreview">
                                 </div>
